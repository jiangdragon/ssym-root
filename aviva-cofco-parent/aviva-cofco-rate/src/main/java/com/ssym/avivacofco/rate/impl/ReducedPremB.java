...
/**
 * @author 三傻云梦
 * @Description 减额交清保费B款, Sheet与保单字段对应关系
 * <br/> RISKCODE:险种编码
 * <br/> DUTYCODE:责任编码
 * <br/> MINAGE:最小年龄
 * <br/> MAXAGE:最大年龄
 ...
 * @Time 2026/2/25
 */
public class ReducedPremB extends AbstractSheetService {
    /**
     * 构造函数
     *
     * @param riskCode 险种编码
     * @param dutyCode 责任编码
     */
    public ReducedPremB(String riskCode, String dutyCode) {
    ...
    protected void init() {
        ...
        this.props.add("N_1_缴费期间");
        this.props.add("N_2_性别");
        this.props.add("N_3_约定年龄");
        ...
        stringBuffer.append("INSERT INTO RATE_DERATING_PREM (RISKCODE, DUTYCODE, MINAGE, MAXAGE, GENDER, PAYUNIT, ");
        ...
        stringBuffer.append("'L', 0, ${POLICYYEAR}, ${RATE}, '" + this.securityFlag + "', null, ${RETIREAGE})");
