 ...
 * @Time 2025/9/17
 */
public class Reduced extends RowSheetRateService {

    public Reduced() {
        this.sqlText = "INSERT INTO NEWLIS.RATE_DERATING (RISKCODE, DUTYCODE, MINAGE, MAXAGE, GENDER, PAYUNIT, PAYPERIOD, PERIODFLAG, PERIOD, POLICYYEAR, RATE, SECURITYFLAG, PLANCODE, RETIREAGE) VALUES ('211510', '151001', ${MINAGE}, ${MAXAGE}, '${GENDER}', '${PAYUNIT}', ${PAYPERIOD}, 'L', 0, ${POLICYYEAR},  ${RATE}, '${SECURITYFLAG}', null, null);";
