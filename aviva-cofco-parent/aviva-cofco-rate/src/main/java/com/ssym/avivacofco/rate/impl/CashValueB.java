...
/**
 * @author 三傻云梦
 * @Description 现金价值表B款, Sheet与保单字段对应关系
 * <br/> RISKCODE:险种编码
 * <br/> DUTYCODE:责任编码
 * <br/> MINAGE:最小年龄
 * <br/> MAXAGE:最大年龄
 ...
 * @Time 2026/2/25
 */
public class CashValueB extends AbstractSheetService {
    /**
     * 构造函数
     *
     * @param riskCode 险种编码
     * @param dutyCode 责任编码
     */
    public CashValueB(String riskCode, String dutyCode) {
    ...
    protected void init() {
        ...
        this.props.add("N_4_约定年龄");
        this.props.add("N_5_年龄");
        ...
        stringBuffer.append("INSERT INTO NEWLIS.RATE_PRESENTPRICE (RISKCODE, DUTYCODE, MINAGE, MAXAGE, GENDER, PAYUNIT, ");
        stringBuffer.append("PAYPERIOD, PERIODFLAG, PERIOD, POLICYYEAR, RATE, AMNT, SECURITYFLAG, PLANCODE, RETIREAGE) VALUES ");
        ...
        stringBuffer.append("'L', 0, ${POLICYYEAR}, ${RATE}, null, '${SECURITYFLAG}', null, ${RETIREAGE})");
